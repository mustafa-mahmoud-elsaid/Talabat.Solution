...
namespace Talabat.Repository.Data.IdentityStore.Migrations
{
    ...
    [Migration("20250220203711_DeleteEmailColumnOfUserAddressTable")]
    partial class DeleteEmailColumnOfUserAddressTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Talabat.Core.Entities.Identity.UserAddress", b =>
                {
                    b.HasOne("Talabat.Core.Entities.Identity.ApplicationUser", "User")
                        .WithOne("Address")
                        .HasForeignKey("Talabat.Core.Entities.Identity.UserAddress", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
